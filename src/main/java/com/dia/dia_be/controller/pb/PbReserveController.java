...
public class PbReserveController {
	...
	public ResponseEntity<?> approveReserves(
		@Parameter(name = "id", description = "승인할 상담 요청의 ID", example = "11") @RequestParam Long id,
	...
	public ResponseEntity<List<ResponseReserveByDateDTO>> getReservesByDate(
		@Parameter(description = "상담날짜", example = "2024-12-15") @RequestParam LocalDate date,
